...
(cl:defmethod cl:initialize-instance :after ((m <Attach-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Attach-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name boeing_gazebo_model_attachment_plugin-srv:<Attach-request> is deprecated: use boeing_gazebo_model_attachment_plugin-srv:Attach-request instead.")))

(cl:ensure-generic-function 'joint_name-val :lambda-list '(m))
(cl:defmethod joint_name-val ((m <Attach-request>))
...
(cl:defmethod link_name_1-val ((m <Attach-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader boeing_gazebo_model_attachment_plugin-srv:link_name_1-val is deprecated.  Use boeing_gazebo_model_attachment_plugin-srv:link_name_1 instead.")
  (link_name_1 m))
...
(cl:defmethod link_name_2-val ((m <Attach-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader boeing_gazebo_model_attachment_plugin-srv:link_name_2-val is deprecated.  Use boeing_gazebo_model_attachment_plugin-srv:link_name_2 instead.")
  (link_name_2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Attach-request>)))
  ...
  "boeing_gazebo_model_attachment_plugin/AttachRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Attach-request)))
  "Returns string type for a service object of type 'Attach-request"
  "boeing_gazebo_model_attachment_plugin/AttachRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Attach-request>)))
  ...
  "2586cf82c17da3ea82111514d10d4265")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Attach-request)))
  "Returns md5sum for a message object of type 'Attach-request"
  "2586cf82c17da3ea82111514d10d4265")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Attach-request>)))
  ...
  (cl:format cl:nil "string joint_name~%string model_name_1~%string link_name_1~%string model_name_2~%string link_name_2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Attach-request)))
  "Returns full string definition for message of type 'Attach-request"
  (cl:format cl:nil "string joint_name~%string model_name_1~%string link_name_1~%string model_name_2~%string link_name_2~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <Attach-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Attach-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name boeing_gazebo_model_attachment_plugin-srv:<Attach-response> is deprecated: use boeing_gazebo_model_attachment_plugin-srv:Attach-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Attach-response>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Attach-response>)))
  ...
  "boeing_gazebo_model_attachment_plugin/AttachResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Attach-response)))
  "Returns string type for a service object of type 'Attach-response"
  "boeing_gazebo_model_attachment_plugin/AttachResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Attach)))
  ...
  "boeing_gazebo_model_attachment_plugin/Attach")